"""
Script to train OCT models using pre-extracted and selected features.
...
def main():
    parser = argparse.ArgumentParser(description='Train OCT models using pre-extracted features')
    ...
    parser.add_argument('--train_labels_file', type=str,
                       default='features/oct_train_features_labels.npy',
    ...
    parser.add_argument('--test_labels_file', type=str,
                       default='features/oct_test_features_labels.npy',
    ...
    parser.add_argument('--feature_selection_method', type=str, default='rfe',
                       ...
                       help='Feature selection method (if re-selecting)')
    ...
    parser.add_argument('--exclude_classes', type=int, nargs='+', default=[2, 5],
                       help='Classes to exclude from training and testing (default: [2, 5])')
    
    args = parser.parse_args()
    
    print("="*70)
    print("OCT Model Training (Using Pre-extracted Features)")
    print("="*70)
    ...
    if args.exclude_classes:
        print(f"Excluding classes: {args.exclude_classes}")
    print("="*70)
    ...
    if args.test_features_file and os.path.exists(args.test_features_file):
        ...
        if test_features is not None:
            # Filter out excluded classes from test set
            ...
            # Remove any labels that weren't in training
    ...
    model_data = {
        ...
        'label_mapping': label_mapping  # Save mapping for future use
    }
